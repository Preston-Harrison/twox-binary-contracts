...
describe('Market.sol', () => {
  ...
  it('open & close a position', async () => {
    ...
    await contracts.Token.approve(contracts.Router.address, bn(10, 18));
    ...
    await contracts.Router.updateAggregatorsAndOpen(
      encodedAggregator,
    ...
    console.log(await contracts.Market.options(1));
  });
});
